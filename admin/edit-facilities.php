                                ...
                                <div class="tab-pane" id="ger">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="title_g" id="title_g" class="form-control" value="<?php echo $facbyid['title_g']; ?>"required="TRUE">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="rus">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="title_r" id="title_r" class="form-control" value="<?php echo $facbyid['title_r']; ?>"required="TRUE">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="chi">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="title_c" id="title_c" class="form-control" value="<?php echo $facbyid['title_c']; ?>"required="TRUE">
                                            </div>
                                        </div>
                                        <div class="form-group">
