                                            ...
                                            if ($details) {
                                                ...
                                                <div class="row" id="facilities"> 
                                                    <?php foreach ($details as $detail) {
                                                        ?>
                                                        <div class="col-md-4 col-sm-6 col-xs-12" style="padding-bottom: 20px;" id="facilities_<?php echo $detail['id']; ?>">
                                                            <div class="slider-image">
                                                                <a class="info" class="example-image-link" data-lightbox="example-set"  href="../images/facilities/<?php echo $detail['image_name']; ?>"> 
                                                                    <img class="example-image img-responsive" src="../images/facilities/thumb/<?php echo $detail['image_name']; ?>" alt=""/> 
                                                                </a> 
                                                            </div>  
