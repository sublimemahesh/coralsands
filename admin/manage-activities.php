                                            ...
                                            <div class="row" id="activities"> 
                                                ...
                                                <div class="col-md-4 col-sm-6 col-xs-12" style="padding-bottom: 20px;" id="acti_<?php echo $activity['id'];?>">
                                                            <div class="slider-image">
                                                                <a class="info" class="example-image-link" data-lightbox="example-set"  href="../images/activities/<?php echo $activity['image_name']; ?>"> 
                                                                    <img class="example-image img-responsive" src="../images/activities/thumb/<?php echo $activity['image_name']; ?>" alt=""/> 
                                                                </a> 
                                                            </div>  
